---
title: Introduction to the Openos CLI
pagination_label: Introduction to the Openos CLI
sidebar_label: Introduction
sidebar_position: 2
---

Before running any Openos CLI commands, let's go over some conventions that
you will see across all commands. First, the Openos CLI is actually a collection
...
`/home/openos/my_wallet.json`, to display the address, do:

```bash
openos-keygen pubkey /home/openos/my_wallet.json
```
