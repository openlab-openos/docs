---
title: Offline Transaction Signing with the Openos CLI
pagination_label: "Openos CLI: Offline Transaction Signing"
...
This document describes using Openos's CLI to separately sign and submit a
transaction.
...
```bash
$ openos transfer --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
$ openos transfer --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
$ openos transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
Typically a Openos transaction must be signed and accepted by the network within
