---
title: Openos Wallets with the CLI
pagination_label: Command Line Wallets
sidebar_label: Overview
sidebar_position: 0
---

Openos supports several different types of wallets that can be used to interface
directly with the Openos command-line tools.

To use a Command Line Wallet, you must first [install the Openos CLI tools](../install.md)
