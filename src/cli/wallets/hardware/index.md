---
title: Using Hardware Wallets in the Openos CLI
pagination_label: "Using Hardware Wallets in the Openos CLI"
sidebar_label: Using in the Openos CLI
sidebar_position: 0
---
...
Openos defines a keypair URL format to uniquely locate any Openos keypair on a
...
`DERVIATION_PATH` is used to navigate to Openos keys within your hardware wallet.
