---
title: "Native Programs in the Openos Runtime"
pagination_label: Runtime Native Programs
sidebar_label: Native Programs
---

Openos contains a small handful of native programs, which are required to run
...
instruction via a program id, the Openos runtime will load both your the program
