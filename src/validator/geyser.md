---
title: Openos Validator Geyser Plugins
...
- [`openos-geyser-plugin-interface`] &mdash; This crate defines the plugin
interfaces.

- [`openos-accountsdb-plugin-postgres`] &mdash; The crate for the referential
plugin implementation for the PostgreSQL database.

[`openos-geyser-plugin-interface`]: https://docs.rs/solana-geyser-plugin-interface
[`openos-accountsdb-plugin-postgres`]: https://docs.rs/solana-accountsdb-plugin-postgres


## The Plugin Interface

The Plugin interface is declared in [`openos-geyser-plugin-interface`]. It
...
please refer to [`openos-sdk`] and [`openos-transaction-status`]

The `slot` points to the slot the transaction is executed at.
For more details, please refer to the Rust documentation in
[`openos-geyser-plugin-interface`].

## Example PostgreSQL Plugin

The [`openos-accountsdb-plugin-postgres`] repository implements a plugin storing
...
```
{
	"libpath": "/openos/target/release/libsolana_geyser_plugin_postgres.so",
