...
- [getFirstAvailableBlock](https://openverse.network//docs/rpc/http/getfirstavailableblock)
- [getConfirmedBlock](https://openverse.network//docs/rpc/deprecated/getconfirmedblock)
- [getConfirmedBlocks](https://openverse.network//docs/rpc/deprecated/getconfirmedblocks)
- [getConfirmedSignaturesForAddress](https://openverse.network//docs/rpc/http/getconfirmedsignaturesforaddress)
- [getConfirmedTransaction](https://openverse.network//docs/rpc/deprecated/getConfirmedTransaction)
- [getSignatureStatuses](https://openverse.network//docs/rpc/http/getsignaturestatuses)
- [getBlockTime](https://openverse.network//docs/rpc/http/getblocktime)
...
the use of a new `openos-ledger-tool` command that will convert rocksdb data for
