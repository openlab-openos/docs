...
Third-party users of Openos sometimes need to know the real-world time a block
...
would allow a Openos cluster to satisfy this need.
...
As of https://github.com/openversenetwork/OpenOS.Prod/pull/10630, validators submit a
