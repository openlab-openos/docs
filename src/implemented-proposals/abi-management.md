---
title: Openos ABI management process
---

This document proposes the Openos ABI management process. The ABI management
...
The Openos ABI (binary interface to the cluster) is currently only defined
...
```
BTGANA_ABI_DUMP_DIR=. cargo +nightly test abi
```
