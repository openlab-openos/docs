...
title: Home
sidebar_label: Home
pagination_label: Openos Validator Documentation Home
description: "Openos is a high performance network that is utilized for a range
  of use cases, \
...
# Openos Validator   
=======
# Openos Validator Documentation
>>>>>>> f791f16382c12fe6838525c605e37586934ee6bf

Openos is a blockchain built for mass adoption. It's a high performance network
that is utilized for a range of use cases, including finance, NFTs, payments,
and gaming. Openos operates as a single global state machine, and is open,
...
- [Install the Openos CLI Tool Suite](./cli/install.md) - Quickly get setup
...
- [Choose a cluster](./cli/examples/choose-a-cluster.md) - Select a Openos
<<<<<<< HEAD
  network cluster to connect (e.g. `devnet`, `mainnet`)
- [Create a wallet](./cli/wallets/index.md) - Create a command line wallet for
  use within the CLI and beyond
- [Free to receive BTG](https://docs.openos.info/) - Free to receive BTG, convenient for development and testing.
=======
...
Explore what it takes to operate a Openos validator and help secure the network.
...
- [System requirements](./operations/requirements.md) - Recommended hardware
  requirements and expected BTG needed to operate a validator
