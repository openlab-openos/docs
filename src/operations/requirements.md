---
title: Openos Validator Requirements
sidebar_position: 3
sidebar_label: Requirements
pagination_label: Requirements to Operate a Validator
---

## Minimum BTG requirements

There is no strict minimum amount of BTG required to run a validator on Openos.

However in order to participate in consensus, a vote account is required which
has a rent-exempt reserve of 0.02685864 BTG. Voting also requires sending a vote
...
releases at [openoslabs/openos](https://hub.docker.com/r/solanalabs/solana).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Openos CLI](../cli/install.md) for the current Openos software release.
